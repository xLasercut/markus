...
//   protected _reloadSchedule: string;
//   protected _apiUrl
//
//   constructor(config: Config, logger: Logger, name: string, fieldsToEncode: Array<string>) {
//     this._name = name;
...
//     let response = await axios.post(this._config.dict[`${this._name}PostsApiUrl`], body);
//     let apiData = [];
//
...
//     let response = await axios.post(this._config.dict[`${this._name}PostsUserApiUrl`], body);
