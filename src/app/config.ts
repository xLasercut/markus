...
class Config {
  ...
  public load(): void {
    this._config = {
      ...
      itemApiUrl: process.env.ITEM_API_URL || 'https://www.ashal.eu/market/api/posts.php',
      tearApiUrl: process.env.TEAR_API_URL || 'https://www.ashal.eu/market/api/tear_posts.php',
      ...
      itemUserApiUrl: process.env.ITEM_USER_API_URL || 'https://www.ashal.eu/market/api/posts_by_user.php',
      tearUserApiUrl: process.env.TEAR_USER_API_URL || 'https://www.ashal.eu/market/api/tear_posts_by_user.php',
